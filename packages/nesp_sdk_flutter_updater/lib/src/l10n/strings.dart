...
abstract class Strings {
  ...
  /// No description provided for @status_empty_data.
  ///
  /// In en, this message translates to:
  /// **'no data'**
  String get status_empty_data;

  /// No description provided for @status_net_lose.
  ///
  /// In en, this message translates to:
  /// **'Please check the network'**
  String get status_net_lose;

  /// No description provided for @status_retry.
  ///
  /// In en, this message translates to:
  /// **'Please click to try again'**
  String get status_retry;

  /// No description provided for @status_failure.
  ///
  /// In en, this message translates to:
  /// **'Operation failed'**
  String get status_failure;
  ...
  /// No description provided for @dialog_updater_title.
  ///
  /// In en, this message translates to:
  /// **'New Version: {versionName}'**
  String dialog_updater_title(String versionName);

  /// No description provided for @msg_update_failed.
  ///
  /// In en, this message translates to:
  /// **'Update Failed'**
