...
import 'package:nesp_sdk_flutter_social/nesp_sdk_flutter_social_platform_interface.dart';
import 'package:nesp_sdk_flutter_social/nesp_sdk_flutter_social_method_channel.dart';
...
class MockNespSdkFlutterSocialPlatform
  ...
  @override
  Future<bool> joinQQGroup({String androidKey = '', String iosKey = '', required String groupUin}) {
    // TODO: implement joinQQGroup
    throw UnimplementedError();
  }
  
  @override
  Future<bool> openOtherApp({String androidPackageName = '', String androidClassName = '', String iosAppUrl = ''}) {
...
void main() {
  final NespSdkFlutterSocialPlatform initialPlatform = NespSdkFlutterSocialPlatform.instance;
